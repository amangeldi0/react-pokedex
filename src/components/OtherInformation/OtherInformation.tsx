        ...
        <div className='other__information'>
            <div className="training oth_inf">
                <div className="train__inf all__inf">
                    ...
                    <div className="inf" style={style}>{captureRate}</div>
                </div>
                <div className="train__inf all__inf">
                    <div className="title">Base Friendship:</div>
                    <div className="inf" style={style}>{baseHappiness}</div>
                </div>
                <div className="train__inf all__inf">
                    <div className="title">Base Exp.</div>
                    <div className="inf" style={style}>{baseExperience}</div>
                </div>
                <div className="train__inf all__inf">
                    <div className="title">Growth Rate</div>
                    <div className="inf" style={style}>{growthRate.name}</div>
                </div>
                <div className="train__inf all__inf">
            ...
            <div className="breeding oth_inf">
                ...
                <div className="bree__inf all__inf">
                    ...
                    <div className="inf" style={style}>{hasGenderDifferences ? 'Yes' : 'No'}</div>
                </div>
                <div className="bree__inf all__inf">
                    <div className="title">Alternative Form</div>
                    <div className="inf" style={style}>{varieties.length <= 1 ? 'No' : 'Yes'}</div>
                </div>
                <div className="bree__inf all__inf">
                    <div className="title">Baby</div>
                    <div className="inf" style={style}>{isBaby ? 'Yes' : 'No'}</div>
                </div>
                <div className="bree__inf all__inf">
                    <div className="title">Legendary</div>
                    <div className="inf" style={style}>{isLegendary ? 'Yes' : 'No'}</div>
                </div>
                <div className="bree__inf all__inf">
                    <div className="title">Mythical</div>
                    <div className="inf" style={style}>{isMythical ? 'Yes' : 'No'}</div>
                </div>
            </div>
            <div className="additional__information oth_inf">
                <div className="add__inf all__inf">
                    <div className="title">Movies Count</div>
                    <div className="inf" style={style}>{moves.length}</div>
                </div>
                <div className="add__inf all__inf">
                    <div className="title">Game Includes Count</div>
                    <div className="inf" style={style}>{gameIndices.length}</div>
                </div>
                <div className="add__inf all__inf">
                    <div className="title">Shape</div>
                    <div className="inf" style={style}>{shape.name}</div>
                </div>
                <div className="add__inf all__inf">
                    <div className="title">Color</div>
                    <div className="inf" style={style}>{COLORS[`${color.name}`]}</div>
                </div>
            </div>
        </div>
    );
